...
description: Scala JVM thread dump capture and analysis guidance based on official language, tool, and diagnostic documentation. Use when diagnosing JVM thread behavior for codex.
---
