...
description: Scala JVM heap, GC, native memory, and leak analysis guidance based on official language, tool, and diagnostic documentation. Use when diagnosing JVM memory behavior for codex.
---
